    ...
    <div class="edit-course-container">
      ...
      <table>
        ...
        <tr v-for="(course, index) in courses" :key="index">
          ...
          <td v-if="!editing[index]">{{ course.lid }}</td>
          ...
          <td v-else>
            ...
            <input v-model="course.lid" placeholder="教师ID">
...
<!--      try {-->
<!--        const response = await axios.get('/api/get-courses'); // 使用 axios.get-->
<!--        courses.value = response.data.courses; // 直接访问 data 属性-->
<!--        editing.value = new Array(response.data.courses.length).fill(false);-->
<!--      } catch (error) {-->
...
<!--      try {-->
<!--        const response = await axios.put(`/api/edit-course/${lId}`, courses.value[index]); // 使用 axios.put 并直接传递对象-->
...
<!--      try {-->
<!--        const response = await axios.delete(`/api/delete-course/${lId}`); // 使用 axios.delete-->
<!--        message.value = response.data.message;-->
